...
export default function Page() {
  ...
  const collections = [
    { 
      ...
      position: { x: 10, y: 15 },
      title: "MAYC",
      subtitle: "SERUM-OBSESSED",
      size: { width: 200, height: 200 },
      textDirection: 'right' as const
    },
    { 
      id: 2, 
      ...
      subtitle: "a staking contract in anchor",
      size: { width: 190, height: 190 },
      textDirection: 'left' as const
    },
    { 
      id: 3, 
      image: "/placeholder.svg?height=300&width=300", 
  ...
  const handleMouseMove = useCallback((e: MouseEvent) => {
    ...
    viewPositionX.set((newX - 0.1) * 500)
    viewPositionY.set((newY - 0.1) * 500)
  ...
  return (
    <div className="relative min-h-screen bg-[#1d1c1b] overflow-hidden cursor-none" ref={containerRef}>
      ...
      <div className="fixed top-0 left-0 right-0 flex justify-between items-center p-4 z-50">
        <NavigationCircle direction="left" onClick={navigatePrev} />
        <NavigationCircle direction="right" onClick={navigateNext} />
      </div>
